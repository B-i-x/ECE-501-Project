-- Query 1 Star Schema: Math source data (All Students only, for school-level proficiency)
-- This replaces create_math_src.sql which used baseline tables

-- Math proficiency at school level (All Students subgroup)
